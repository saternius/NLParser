...
public class PDFTextStripper extends PDFTextStreamEngine
{
    ...
    static boolean setFontThreshHold = false;
    static float fontThreshHold = (float) 7.0;
    private double fontHighestHeight = 9999;
     ...
     */
    public void setFontThreshHold(float f){
    	setFontThreshHold = true;
    	fontThreshHold = f;
    }
    
    public void setFontHighestHeight(double d){
    	fontHighestHeight = d;
    }
    ...
    protected void processTextPosition(TextPosition text)
    {
    	...
    	if(setFontThreshHold && text.getFontSizeInPt() != fontThreshHold){
    		return;
    	}
    	if(text.getHeight() > fontHighestHeight){
    		return;
    	}
